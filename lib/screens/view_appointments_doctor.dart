...
class ViewAppointmentsDoctor extends StatefulWidget {
  ...
  final int tabNumber; 
  const ViewAppointmentsDoctor({Key key, this.doctorModel, this.tabNumber}) : super(key: key);

  @override
  _ViewAppointmentsDoctorState createState() => _ViewAppointmentsDoctorState();
}

class _ViewAppointmentsDoctorState extends State<ViewAppointmentsDoctor>
  ...
  Future<void> getAppointments() async {
    var data = await databaseMethods.getAppointments(widget.doctorModel.docEmail);
  ...
  createChatRoomAndStartConversation(String username) {
    if (username != widget.doctorModel.name) {
      String chatRoomId = getChatRoomId(username, widget.doctorModel.name);
      List<String> users = [username, widget.doctorModel.name];
                            ...
                            Row(
                              ...
                              children: [
                                Button(btnTitle: '😊 View Profile',pressed: (){
                                  // Navigator.push(context, MaterialPageRoute(builder: (context)=>DoctorDetails(doctorModel: upcomingAppointmentsList[index].doctor,userModel: widget.doctorModel,)));
                                },),
                                Button(btnTitle: '📞 Call Patient'),
                                Button(btnTitle: '💬 Chat Patient',pressed: (){
                                  createChatRoomAndStartConversation(upcomingAppointmentsList[index].patient.name);
                                },),
                              ],
                            ),
                            Divider(
